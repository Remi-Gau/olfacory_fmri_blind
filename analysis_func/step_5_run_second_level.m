...
opt.ctrsts = { ...
    ...
    'Alm-Left + Alm-Right > 0', 'Alm > baseline - whole brain', []; ...
    'Alm-Left + Alm-Right < 0', 'Alm < baseline - whole brain', []; ...
    'Euc-Left + Euc-Right > 0', 'Euc > baseline - whole brain', []; ...
    'Euc-Left + Euc-Right < 0', 'Euc < baseline - whole brain', []; ...
    'Euc-Right + Alm-Right > 0', 'right nostril > baseline - whole brain', []; ...
    'Euc-Right + Alm-Right < 0', 'right nostril < baseline - whole brain', []; ...
    'Euc-Left + Alm-Left > 0', 'left nostril > baseline - whole brain', []; ...
    'Euc-Left + Alm-Left < 0', 'left nostril < baseline - whole brain', []; ...
    'Euc-Left > 0', 'Euc-Left > baseline - whole brain', []; ...
    'Euc-Left < 0', 'Euc-Left < baseline - whole brain', []; ...
    'Alm-Left > 0', 'Alm-Left > baseline - whole brain', []; ...
    'Alm-Left < 0', 'Alm-Left < baseline - whole brain', []; ...
    'Euc-Right > 0', 'Euc-Right > baseline - whole brain', []; ...
    'Euc-Right < 0', 'Euc-Right < baseline - whole brain', []; ...
    'Alm-Right > 0', 'Alm-Right > baseline - whole brain', []; ...
    'Alm-Right < 0', 'Alm-Right < baseline - whole brain', []; ...
    };
